...
useMemo เป็น React Hook ที่ใช้เก็บค่าผลลัพธ์จากการคำนวณ เพื่อไม่ต้องคำนวณใหม่ทุกครั้งที่ Component Render โดยจะคำนวณใหม่เมื่อข้อมูลที่เกี่ยวข้องมีการเปลี่ยนแปลง
...
จากโค้ดใช้ `useMemo` เพื่อคำนวณราคาสินค้าทั้งหมดในตะกร้า โดยจะคำนวณใหม่เมื่อข้อมูล `cart` มีการเปลี่ยนแปลง
...
เลือกใช้ useMemo เพราะในระบบมีการคำนวณข้อมูล เช่น การหาราคารวมของสินค้า และการกรองเมนูสินค้า ถ้าข้อมูลไม่ได้เปลี่ยนก็ไม่ต้องคำนวณใหม่ทุกครั้ง ช่วยลดการทำงานที่ไม่จำเป็นของระบบ
...
- ไม่จำเป็นต่อการคำนวณที่ง่ายและใช้เวลาไม่นาน
- หากใช้มากเกินไปโค้ดจะดูซับซ้อนและทำความเข้าใจยากขึ้น
...
useCallback เป็น React Hook ที่ใช้จดจำฟังก์ชัน เพื่อไม่ให้สร้างฟังก์ชันใหม่ทุกครั้งที่ Component Render โดยฟังก์ชันจะถูกสร้างใหม่เมื่อค่าที่กำหนดไว้ใน Dependency เปลี่ยนแปลง
